...
import overhead from '../../assets/experience/canopy-dash/overhead.png';

<figure>
  <p align="center">
    <Image densities={[1, 2]} src={overhead} alt="" height={300} style={{ display: 'block', margin: '0 auto', padding: '5px', boxSizing: 'border-box' }} />
  </p>
  <figcaption style={{ textAlign: 'center', fontStyle: 'italic' }}>Overhead view of basil plants</figcaption>
</figure>
