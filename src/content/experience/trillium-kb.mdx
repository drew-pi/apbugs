...
import gala from '../../assets/experience/trillium/gala.jpg';

<figure>
  <p align="center">
    <Image densities={[1, 2]} src={gala} alt="" height={500} style={{ display: 'block', margin: '0 auto', padding: '5px', boxSizing: 'border-box' }} />
  </p>
  <figcaption style={{ textAlign: 'center', fontStyle: 'italic' }}>The manager of the Knowledge Base team, John Heffernan, and I at the end-of-year Trillium Gala, January 2024</figcaption>
</figure>
